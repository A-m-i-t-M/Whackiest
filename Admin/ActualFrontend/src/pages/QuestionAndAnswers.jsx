  ...
  return (
    ...
    >
      <div className="relative flex items-center mb-8">
        ...
        <button className="absolute right-0 bg-red-500 text-white text-sm font-medium py-2 px-4 rounded-lg hover:bg-red-600 transition" onClick={()=> navigate("/answers")}>
            View Progress
        </button>
      </div>
