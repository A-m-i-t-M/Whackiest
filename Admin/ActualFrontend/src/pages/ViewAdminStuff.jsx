...
export default function ViewAdminStuff() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-yellow-50 to-orange-100 py-10 px-5">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {darshanbookings.map((booking, index) => (
          <div
            ...
            <button
              className="ml-64 mr-0 bg-orange-500 text-white py-2 px-4 rounded hover:bg-orange-600"
      ...
      <h1 className="font-bold text-2xl ml-4 text-gray-800">Services</h1>
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
      ...
      {isDialogOpen && (
        <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex justify-center items-center">
          <div className="bg-gradient-to-br from-yellow-200 to-orange-300 p-6 rounded-lg shadow-lg w-80">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Do you want to delete it?</h2>
